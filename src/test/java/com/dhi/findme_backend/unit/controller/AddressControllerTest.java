...
class AddressControllerTest {
    ...
    void createAddress_withValidData_shouldSucceed() throws Exception {
        AddressCreateRequest request = new AddressCreateRequest("Home", "sn", "Dakar", "Plateau", "Rue 1", "Pr̬s du march̩", 14.0, -17.0, null, "Personal");
    ...
    void createAddress_whenAddressLimitReached_shouldReturnBadRequest() throws Exception {
        AddressCreateRequest request = new AddressCreateRequest("New Address", "sn", "Dakar", "Plateau", "Rue 2", "Pr̬s de l'̩cole", 14.7167, -17.4677, null, "Personnel");
