...
class SupportControllerTest {
    ...
    void uploadAttachment_withValidFile_shouldSucceed() throws Exception {
        ...
        SupportAttachmentUploadResponse response = new SupportAttachmentUploadResponse("http://localhost:8080/uploads/support-attachments/test.pdf", "Fichier upload̩ avec succ̬s");
