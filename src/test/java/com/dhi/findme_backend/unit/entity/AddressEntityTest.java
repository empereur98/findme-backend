...
class AddressEntityTest {
    ...
    void testAddressCreation_WithValidData_ShouldCreateAddress() {
        ...
        assertEquals("S̩n̩gal", address.getCountry());
    ...
    void testAddressLandmark_ShouldBeSettable() {
        address.setLandmark("Pr̬s du march̩");
        assertEquals("Pr̬s du march̩", address.getLandmark());
    }
    ...
    void testAddressStatus_ShouldBeSettable() {
        address.setStatus("Valid̩");
        assertEquals("Valid̩", address.getStatus());
    }
