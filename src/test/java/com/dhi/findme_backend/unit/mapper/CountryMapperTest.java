package com.dhi.findme_backend.unit.mapper;
...
class CountryMapperTest {
    ...
    void setUp() {
        ...
        testCountry.setNameFr("S̩n̩gal");
        testCountry.setNameEn("Senegal");
        testCountry.setCities("Dakar, Saint-Louis, Thi̬s");
    }
    ...
    void testToCountryResponse_WithAllFields_ShouldMapCorrectly() {
        ...
        assertTrue(response.cities().contains(" Thi̬s"));
    }
    ...
    void testToCountryResponse_CitiesWithSpaces_ShouldNotTrim() {
        ...
        assertEquals(" Thi̬s", response.cities().get(2));
    }
}
