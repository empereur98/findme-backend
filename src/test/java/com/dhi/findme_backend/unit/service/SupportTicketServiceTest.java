package com.dhi.findme_backend.unit.service;
...
import com.dhi.findme_backend.mapper.*;
...
class SupportTicketServiceTest {
    ...
    void setUp() {
        ...
        createRequest = new SupportTicketCreateRequest(
                ...
                "Je n'arrive pas Ã  me connecter Ã  mon compte",
                "technique",
                null
        );
        ...
        testTicket.setSubject("ProblÃ¨me de connexion");
        testTicket.setMessage("Je n'arrive pas Ã  me connecter Ã  mon compte");
        testTicket.setType("technique");
        testTicket.setStatus("Non traitÃ©");
    ...
    void testCreateTicket_Success() {
        ...
        assertEquals("ProblÃ¨me de connexion", response.subject());
        assertEquals("technique", response.type());
        assertEquals("Non traitÃ©", response.status());
    ...
    void testCreateTicket_DifferentTypes() {
        SupportTicketCreateRequest billingRequest = new SupportTicketCreateRequest(
                ...
                "Mon abonnement a Ã©tÃ© facturÃ© deux fois",
                "facturation",
                null
        );
    ...
    void testGetTickets_WithFilters() {
        ...
        Pageable pageable = PageRequest.of(0, 10);
        var response = supportTicketService.getTickets(pageable, "connexion", "Non traitÃ©", "technique");
